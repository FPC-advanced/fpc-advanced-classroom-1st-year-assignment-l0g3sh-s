...
void input(int *num1, int *den1, int *num2, int *den2) {
    printf("Enter numerator and denominator for fraction 1 (numerator/denominator): ");
    scanf("%d/%d", num1, den1);
    printf("Enter numerator and denominator for fraction 2 (numerator/denominator): ");
    scanf("%d/%d", num2, den2);
}
